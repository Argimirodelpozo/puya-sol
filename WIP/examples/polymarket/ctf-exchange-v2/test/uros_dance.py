...
REPO_ROOT = Path(__file__).resolve().parents[5]  # → puya-sol/
# (one level deeper than morpho-blue's uros_dance.py because polymarket is
# under examples/polymarket/{ctf-exchange,ctf-exchange-v2}/ — extra dir.)
