...
// Flattened: Context + IERC165 + ERC165 + IERC721 + IERC721Metadata + IERC721Receiver + IERC721Errors + ERC721
...
// --- Strings.sol (utils/Strings.sol) — minimal for Algorand compilation ---
// The full OZ Strings library uses Math.log10 + EVM assembly (mstore8/ptr arithmetic)
// which have no AVM equivalent. Since tokenURI() is overridden in test wrappers,
// this stub satisfies the type checker without needing EVM-specific operations.
...
contract ERC721Test is ERC721 {
    ...
    // Override tokenURI to avoid Strings library dependency
    // (Strings.toString uses Math.log10 which requires additional libraries)
