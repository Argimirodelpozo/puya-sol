...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d6_5).
contract Kd6_5_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mTwice() mPost() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
