...
// Wrapper exposing Solady LibBit pure bit-trick functions for differential fuzzing.
contract LibBitWrapper {
    function fls(uint256 x) external pure returns (uint256) { return LibBit.fls(x); }
    function clz(uint256 x) external pure returns (uint256) { return LibBit.clz(x); }
    function ffs(uint256 x) external pure returns (uint256) { return LibBit.ffs(x); }
    function popCount(uint256 x) external pure returns (uint256) { return LibBit.popCount(x); }
    function countZeroBytes(uint256 x) external pure returns (uint256) { return LibBit.countZeroBytes(x); }
    function isPo2(uint256 x) external pure returns (bool) { return LibBit.isPo2(x); }
    function reverseBits(uint256 x) external pure returns (uint256) { return LibBit.reverseBits(x); }
    function reverseBytes(uint256 x) external pure returns (uint256) { return LibBit.reverseBytes(x); }
    function commonBitPrefix(uint256 x, uint256 y) external pure returns (uint256) { return LibBit.commonBitPrefix(x, y); }
    function commonNibblePrefix(uint256 x, uint256 y) external pure returns (uint256) { return LibBit.commonNibblePrefix(x, y); }
    function commonBytePrefix(uint256 x, uint256 y) external pure returns (uint256) { return LibBit.commonBytePrefix(x, y); }
    function andB(bool x, bool y) external pure returns (bool) { return LibBit.and(x, y); }
    function orB(bool x, bool y) external pure returns (bool) { return LibBit.or(x, y); }
    function toUint(bool b) external pure returns (uint256) { return LibBit.toUint(b); }
}
