...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d4_7).
contract Kd4_7_0 {
    uint256 public log;
...
contract Kd4_7_1 is Kd4_7_0 {
    function f0(uint256 a) public override mArg(bump(a)) mPre() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
    function f1(uint256 a) public override mGate() mTwice() mBoth() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}