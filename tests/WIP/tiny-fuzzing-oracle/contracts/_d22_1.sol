...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d22_1).
contract Kd22_1_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mGate() mGate() mPost() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public mTwice() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd22_1_1 is Kd22_1_0 {
}