...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d5_0).
contract Kd5_0_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public mArg(a % 5) mBoth() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd5_0_1 is Kd5_0_0 {
    function f0(uint256 a) public override mGate() mPost() mBoth() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
}
contract Kd5_0_2 is Kd5_0_1 {
}