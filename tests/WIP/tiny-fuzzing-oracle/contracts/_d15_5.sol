...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d15_5).
contract Kd15_5_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public virtual mPre() mGate() mTwice() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
    function f2(uint256 a) public virtual mPre() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd15_5_1 is Kd15_5_0 {
    function f0(uint256 a) public override { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public override mArg(a % 5) mTwice() mGate() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; super.f1(a); }
