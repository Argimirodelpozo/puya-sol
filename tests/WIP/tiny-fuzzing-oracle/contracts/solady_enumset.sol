...
// Concrete Uint256Set for differential fuzzing of Solady EnumerableSetLib.
contract EnumSetTest {
    using EnumerableSetLib for EnumerableSetLib.Uint256Set;
    EnumerableSetLib.Uint256Set private s;
    function add(uint256 v) external returns (bool) { return s.add(v); }
    function remove(uint256 v) external returns (bool) { return s.remove(v); }
    function contains(uint256 v) external view returns (bool) { return s.contains(v); }
    function length() external view returns (uint256) { return s.length(); }
    function at(uint256 i) external view returns (uint256) { return s.at(i); }
    function indexOf(uint256 v) external view returns (uint256) { return s.indexOf(v); }
}
