...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d7_3).
contract Kd7_3_0 {
    uint256 public log;
    ...
    function f2(uint256 a) public virtual mPre() mTwice() mGate() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
    function f3(uint256 a) public returns (uint256) { unchecked { log = log*100 + 23 + (a % 7); } return log; }
}
contract Kd7_3_1 is Kd7_3_0 {
    function f0(uint256 a) public override mTwice() mBoth() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
