...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d16_3).
contract Kd16_3_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mPost() mGate() mArg(a % 5) { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    ...
    function f3(uint256 a) public virtual mTwice() returns (uint256) { unchecked { log = log*100 + 23 + (a % 7); } return log; }
}
contract Kd16_3_1 is Kd16_3_0 {
