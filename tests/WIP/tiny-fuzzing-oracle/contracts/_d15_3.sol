...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d15_3).
contract Kd15_3_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mPost() mTwice() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
    function f1(uint256 a) public virtual mGate() mArg(bump(a)) mBoth() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
    function f2(uint256 a) public virtual { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd15_3_1 is Kd15_3_0 {
    function f1(uint256 a) public override virtual mArg(a % 5) returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
}
contract Kd15_3_2 is Kd15_3_1 {
