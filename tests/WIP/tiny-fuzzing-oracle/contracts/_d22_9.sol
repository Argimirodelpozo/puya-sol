...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d22_9).
contract Kd22_9_0 {
    uint256 public log;
...
contract Kd22_9_1 is Kd22_9_0 {
    function f1(uint256 a) public override virtual mPost() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd22_9_2 is Kd22_9_1 {
    function f0(uint256 a) public override virtual mTwice() mArg(bump(a)) mPost() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
}
contract Kd22_9_3 is Kd22_9_2 {
