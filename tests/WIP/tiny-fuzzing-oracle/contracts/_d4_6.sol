...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d4_6).
contract Kd4_6_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public mTwice() mPost() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
    function f2(uint256 a) public mTwice() mPost() mGate() returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return log; }
}
contract Kd4_6_1 is Kd4_6_0 {
}