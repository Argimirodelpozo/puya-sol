...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d18_7).
contract Kd18_7_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public virtual mGate() mTwice() mBoth() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd18_7_1 is Kd18_7_0 {
    function f0(uint256 a) public override virtual returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
    function f1(uint256 a) public override mPre() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd18_7_2 is Kd18_7_1 {
    function f0(uint256 a) public override virtual returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
}
contract Kd18_7_3 is Kd18_7_2 {
