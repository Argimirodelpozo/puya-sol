...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d2_2).
contract Kd2_2_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mGate() mPre() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public mArg(a % 5) { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd2_2_1 is Kd2_2_0 {
