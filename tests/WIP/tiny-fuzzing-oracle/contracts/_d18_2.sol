...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d18_2).
contract Kd18_2_0 {
    uint256 public log;
    ...
    function f2(uint256 a) public mTwice() mBoth() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd18_2_1 is Kd18_2_0 {
    function f1(uint256 a) public override mPost() mPre() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; super.f1(a); }
}