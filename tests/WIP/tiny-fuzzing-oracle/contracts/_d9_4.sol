...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d9_4).
contract Kd9_4_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mPre() mPre() mArg(bump(a)) { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public mGate() mPre() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd9_4_1 is Kd9_4_0 {
