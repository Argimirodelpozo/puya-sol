...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d22_5).
contract Kd22_5_0 {
    uint256 public log;
...
contract Kd22_5_1 is Kd22_5_0 {
    function f0(uint256 a) public override virtual mArg(bump(a)) { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
}
contract Kd22_5_2 is Kd22_5_1 {
    function f0(uint256 a) public override mArg(a % 5) mPre() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public override virtual mPost() mPost() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd22_5_3 is Kd22_5_2 {
