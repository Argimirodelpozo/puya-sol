...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d14_0).
contract Kd14_0_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mGate() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
    function f1(uint256 a) public virtual mArg(bump(a)) mTwice() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd14_0_1 is Kd14_0_0 {
    function f1(uint256 a) public override virtual mBoth() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; super.f1(a); }
}
contract Kd14_0_2 is Kd14_0_1 {
