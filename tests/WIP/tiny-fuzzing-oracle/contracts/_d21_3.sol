...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d21_3).
contract Kd21_3_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mPost() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
    function f1(uint256 a) public virtual mTwice() mArg(bump(a)) returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd21_3_1 is Kd21_3_0 {
    function f0(uint256 a) public override returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
}
contract Kd21_3_2 is Kd21_3_1 {
    function f1(uint256 a) public override mPre() mGate() mBoth() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
}