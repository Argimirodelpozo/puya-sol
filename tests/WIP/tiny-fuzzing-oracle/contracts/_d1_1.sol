...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d1_1).
contract Kd1_1_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mArg(bump(a)) mGate() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
...
contract Kd1_1_1 is Kd1_1_0 {
    function f1(uint256 a) public override mGate() mBoth() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
