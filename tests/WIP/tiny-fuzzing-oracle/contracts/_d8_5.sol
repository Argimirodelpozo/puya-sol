...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d8_5).
contract Kd8_5_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mGate() mGate() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public mArg(a % 5) mTwice() mPost() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
