...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d17_8).
contract Kd17_8_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public mBoth() mBoth() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd17_8_1 is Kd17_8_0 {
}
contract Kd17_8_2 is Kd17_8_1 {
    function f0(uint256 a) public override mPre() mGate() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
}