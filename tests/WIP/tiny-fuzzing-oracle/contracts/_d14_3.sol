...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d14_3).
contract Kd14_3_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public mBoth() mGate() mTwice() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd14_3_1 is Kd14_3_0 {
