...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d10_7).
contract Kd10_7_0 {
    uint256 public log;
...
contract Kd10_7_1 is Kd10_7_0 {
    function f0(uint256 a) public override mPost() mTwice() mPost() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public override mGate() mBoth() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; super.f1(a); }
}
contract Kd10_7_2 is Kd10_7_1 {
}