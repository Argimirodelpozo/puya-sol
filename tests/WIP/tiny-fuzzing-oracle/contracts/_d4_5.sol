...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d4_5).
contract Kd4_5_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mPre() mTwice() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public virtual mTwice() mBoth() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
    function f2(uint256 a) public virtual mGate() mPre() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
    function f3(uint256 a) public virtual mGate() mGate() { unchecked { log = log*100 + 23 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd4_5_1 is Kd4_5_0 {
