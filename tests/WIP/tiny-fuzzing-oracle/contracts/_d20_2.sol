...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d20_2).
contract Kd20_2_0 {
    uint256 public log;
...
contract Kd20_2_1 is Kd20_2_0 {
    function f0(uint256 a) public override { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
    function f2(uint256 a) public override mTwice() mGate() mBoth() returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return super.f2(a); }
}