...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d13_8).
contract Kd13_8_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public mPre() mPost() mArg(bump(a)) { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd13_8_1 is Kd13_8_0 {
}