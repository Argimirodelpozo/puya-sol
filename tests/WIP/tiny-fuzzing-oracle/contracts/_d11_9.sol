...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d11_9).
contract Kd11_9_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public virtual mGate() mArg(a % 5) returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
    function f2(uint256 a) public virtual mArg(bump(a)) { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
    function f3(uint256 a) public virtual mBoth() mGate() mTwice() { unchecked { log = log*100 + 23 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd11_9_1 is Kd11_9_0 {
    function f1(uint256 a) public override virtual returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
}
contract Kd11_9_2 is Kd11_9_1 {
    function f2(uint256 a) public override virtual mArg(a % 5) mPre() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; super.f2(a); }
}
contract Kd11_9_3 is Kd11_9_2 {
    function f0(uint256 a) public override returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
    function f1(uint256 a) public override mArg(bump(a)) mBoth() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
    function f2(uint256 a) public override mTwice() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; super.f2(a); }
    function f3(uint256 a) public override mPost() mBoth() { unchecked { log = log*100 + 23 + (a % 7); } sum += (a % 13) + 1; super.f3(a); }
}