...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d12_9).
contract Kd12_9_0 {
    uint256 public log;
    ...
    function f2(uint256 a) public mPre() mPost() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
    function f3(uint256 a) public mArg(a % 5) mGate() mTwice() returns (uint256) { unchecked { log = log*100 + 23 + (a % 7); } return log; }
}
contract Kd12_9_1 is Kd12_9_0 {
}