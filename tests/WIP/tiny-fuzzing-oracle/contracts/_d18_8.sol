...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d18_8).
contract Kd18_8_0 {
    uint256 public log;
...
contract Kd18_8_1 is Kd18_8_0 {
    function f1(uint256 a) public override mPre() mBoth() mTwice() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; super.f1(a); }
}