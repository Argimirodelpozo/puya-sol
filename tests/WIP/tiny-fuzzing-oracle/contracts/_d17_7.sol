...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d17_7).
contract Kd17_7_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mGate() mBoth() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
...
contract Kd17_7_1 is Kd17_7_0 {
    ...
    function f2(uint256 a) public override virtual mTwice() mBoth() returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return super.f2(a); }
}
contract Kd17_7_2 is Kd17_7_1 {
    function f0(uint256 a) public override mGate() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
    function f1(uint256 a) public override virtual mTwice() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
    function f2(uint256 a) public override mPost() mBoth() returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return super.f2(a); }
}
contract Kd17_7_3 is Kd17_7_2 {
