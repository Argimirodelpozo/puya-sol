...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d15_9).
contract Kd15_9_0 {
    uint256 public log;
...
contract Kd15_9_1 is Kd15_9_0 {
    function f0(uint256 a) public override virtual mPre() mArg(bump(a)) returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
    function f1(uint256 a) public override virtual mPost() mPost() mGate() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
}
contract Kd15_9_2 is Kd15_9_1 {
}
contract Kd15_9_3 is Kd15_9_2 {
