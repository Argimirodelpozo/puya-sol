...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d14_5).
contract Kd14_5_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mPost() mTwice() mBoth() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public virtual mPost() mGate() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd14_5_1 is Kd14_5_0 {
    function f0(uint256 a) public override mPre() mPost() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
}
contract Kd14_5_2 is Kd14_5_1 {
    function f1(uint256 a) public override mBoth() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; super.f1(a); }
}