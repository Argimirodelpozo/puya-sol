...
// GENERATED nested-aggregate fixture (fuzz_nested.py, tag nst24400_7, container mapmap).
contract G_nst24400_7 {
    struct L0 { int8 a0; int32 a1; address a2; }
    ...
    function set_a1(uint256 k, int32 v) external { mm[k][uint8(k >> 8)].mid.inner.a1 = v; }
    function get_a1(uint256 k) external view returns (int32) { return mm[k][uint8(k >> 8)].mid.inner.a1; }
    function bump_a1(uint256 k, int32 d) external { unchecked { mm[k][uint8(k >> 8)].mid.inner.a1 += d; } }
