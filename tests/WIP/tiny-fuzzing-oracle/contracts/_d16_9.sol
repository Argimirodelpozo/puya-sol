...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d16_9).
contract Kd16_9_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public mPre() mPost() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
    function f2(uint256 a) public virtual returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return log; }
}
contract Kd16_9_1 is Kd16_9_0 {
    function f0(uint256 a) public override mTwice() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
    function f2(uint256 a) public override mGate() mPost() mPost() returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return super.f2(a); }
}