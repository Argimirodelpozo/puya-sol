...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d19_8).
contract Kd19_8_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public mTwice() mBoth() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
    function f2(uint256 a) public virtual mBoth() mPost() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
    function f3(uint256 a) public mBoth() returns (uint256) { unchecked { log = log*100 + 23 + (a % 7); } return log; }
}
contract Kd19_8_1 is Kd19_8_0 {
