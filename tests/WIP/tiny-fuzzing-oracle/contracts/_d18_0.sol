...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d18_0).
contract Kd18_0_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public mGate() mTwice() mBoth() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
    function f2(uint256 a) public virtual mTwice() mGate() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd18_0_1 is Kd18_0_0 {
