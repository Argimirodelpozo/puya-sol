...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d5_7).
contract Kd5_7_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mBoth() mTwice() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    ...
    function f3(uint256 a) public mBoth() mPost() mBoth() { unchecked { log = log*100 + 23 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd5_7_1 is Kd5_7_0 {
