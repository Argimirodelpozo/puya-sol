...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d22_6).
contract Kd22_6_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public mArg(a % 5) mTwice() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
    function f2(uint256 a) public mPre() mArg(a % 5) mArg(a % 5) { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd22_6_1 is Kd22_6_0 {
}