...
library ERC721Utils {
    ...
    function checkOnERC721Received(
        ...
        // Stubbed for this differential fixture: the safe-transfer receiver
        // check uses address(to).code + try/catch (no AVM equivalent, correct
        // hard-errors). The wrapper uses _mint / transferFrom only, never a safe
        // transfer, so this is never reached at runtime.
        operator; from; to; tokenId; data;
    }
}
...
// Concrete mintable/burnable ERC721Enumerable for differential fuzzing.
