...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d21_5).
contract Kd21_5_0 {
    uint256 public log;
...
contract Kd21_5_2 is Kd21_5_1 {
    function f3(uint256 a) public override mArg(bump(a)) mArg(a % 5) mBoth() { unchecked { log = log*100 + 23 + (a % 7); } sum += (a % 13) + 1; super.f3(a); }
}