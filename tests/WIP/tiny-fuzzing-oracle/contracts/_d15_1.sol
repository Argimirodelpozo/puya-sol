...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d15_1).
contract Kd15_1_0 {
    uint256 public log;
...
contract Kd15_1_1 is Kd15_1_0 {
    function f1(uint256 a) public override virtual mPre() mTwice() mArg(a % 5) { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; super.f1(a); }
}
contract Kd15_1_2 is Kd15_1_1 {
