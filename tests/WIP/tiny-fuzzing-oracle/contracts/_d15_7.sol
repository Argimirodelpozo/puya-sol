...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d15_7).
contract Kd15_7_0 {
    uint256 public log;
...
contract Kd15_7_1 is Kd15_7_0 {
    function f1(uint256 a) public override mGate() mGate() mGate() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
