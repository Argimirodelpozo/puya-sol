...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d8_2).
contract Kd8_2_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mBoth() mBoth() mPost() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
...
contract Kd8_2_1 is Kd8_2_0 {
    function f1(uint256 a) public override mBoth() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
