...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d18_1).
contract Kd18_1_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mBoth() mArg(a % 5) mBoth() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd18_1_1 is Kd18_1_0 {
