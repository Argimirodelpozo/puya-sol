...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d7_1).
contract Kd7_1_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public virtual mPre() mGate() mPre() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd7_1_1 is Kd7_1_0 {
    function f0(uint256 a) public override virtual mTwice() mPre() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
    function f1(uint256 a) public override virtual mTwice() mPost() mPost() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
}
contract Kd7_1_2 is Kd7_1_1 {
    function f1(uint256 a) public override mPre() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
}
contract Kd7_1_3 is Kd7_1_2 {
