...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d13_7).
contract Kd13_7_0 {
    uint256 public log;
    ...
    function f2(uint256 a) public mTwice() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
    function f3(uint256 a) public virtual mPost() { unchecked { log = log*100 + 23 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd13_7_1 is Kd13_7_0 {
    function f0(uint256 a) public override mGate() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
    function f1(uint256 a) public override mArg(a % 5) mArg(bump(a)) mPre() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; super.f1(a); }
    function f3(uint256 a) public override mArg(a % 5) mPost() { unchecked { log = log*100 + 23 + (a % 7); } sum += (a % 13) + 1; super.f3(a); }
}