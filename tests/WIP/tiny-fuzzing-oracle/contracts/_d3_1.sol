...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d3_1).
contract Kd3_1_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mPre() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public virtual mPost() mPost() mArg(bump(a)) returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
    function f2(uint256 a) public mBoth() returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return log; }
}
contract Kd3_1_1 is Kd3_1_0 {
