...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d6_0).
contract Kd6_0_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mPre() mPost() mTwice() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
    function f1(uint256 a) public virtual { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd6_0_1 is Kd6_0_0 {
}
contract Kd6_0_2 is Kd6_0_1 {
