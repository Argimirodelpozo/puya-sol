...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d22_0).
contract Kd22_0_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mPre() mPre() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
    ...
    function f3(uint256 a) public virtual mBoth() mTwice() { unchecked { log = log*100 + 23 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd22_0_1 is Kd22_0_0 {
    function f0(uint256 a) public override virtual mPost() mPost() mTwice() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
}
contract Kd22_0_2 is Kd22_0_1 {
    function f2(uint256 a) public override returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return super.f2(a); }
}
contract Kd22_0_3 is Kd22_0_2 {
    function f0(uint256 a) public override returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
    function f1(uint256 a) public override mPre() mBoth() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
    function f3(uint256 a) public override mPre() mPost() mGate() { unchecked { log = log*100 + 23 + (a % 7); } sum += (a % 13) + 1; super.f3(a); }
}