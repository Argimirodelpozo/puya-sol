...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d4_4).
contract Kd4_4_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mBoth() mArg(bump(a)) mBoth() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public virtual mGate() mBoth() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd4_4_1 is Kd4_4_0 {
    function f0(uint256 a) public override mPost() mBoth() mTwice() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
