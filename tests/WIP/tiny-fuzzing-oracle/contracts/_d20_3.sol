...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d20_3).
contract Kd20_3_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mTwice() mArg(bump(a)) mBoth() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public virtual mTwice() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd20_3_1 is Kd20_3_0 {
