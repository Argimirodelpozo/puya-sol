...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d5_9).
contract Kd5_9_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mArg(bump(a)) mBoth() mBoth() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
...
contract Kd5_9_1 is Kd5_9_0 {
    function f0(uint256 a) public override virtual returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
}
contract Kd5_9_2 is Kd5_9_1 {
    function f0(uint256 a) public override mPre() mPost() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
