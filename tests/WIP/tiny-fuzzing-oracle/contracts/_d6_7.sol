...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d6_7).
contract Kd6_7_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mPost() mBoth() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public virtual returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd6_7_1 is Kd6_7_0 {
    function f1(uint256 a) public override virtual mArg(bump(a)) mTwice() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
}
contract Kd6_7_2 is Kd6_7_1 {
