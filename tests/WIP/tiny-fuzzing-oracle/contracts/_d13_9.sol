...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d13_9).
contract Kd13_9_0 {
    uint256 public log;
    ...
    function f2(uint256 a) public virtual mArg(a % 5) mBoth() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd13_9_1 is Kd13_9_0 {
    function f2(uint256 a) public override mBoth() mBoth() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; super.f2(a); }
}
contract Kd13_9_2 is Kd13_9_1 {
    function f1(uint256 a) public override mPost() mPost() mPost() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; super.f1(a); }
}