...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d17_1).
contract Kd17_1_0 {
    uint256 public log;
...
contract Kd17_1_1 is Kd17_1_0 {
    function f2(uint256 a) public override mPost() mPre() mBoth() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; super.f2(a); }
    function f3(uint256 a) public override mGate() mPost() returns (uint256) { unchecked { log = log*100 + 23 + (a % 7); } return log; }
}