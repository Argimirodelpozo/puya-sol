...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d6_3).
contract Kd6_3_0 {
    uint256 public log;
...
contract Kd6_3_1 is Kd6_3_0 {
    function f0(uint256 a) public override virtual { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
}
contract Kd6_3_2 is Kd6_3_1 {
    function f0(uint256 a) public override mPre() mPost() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public override virtual mPost() mPre() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
}
contract Kd6_3_3 is Kd6_3_2 {
