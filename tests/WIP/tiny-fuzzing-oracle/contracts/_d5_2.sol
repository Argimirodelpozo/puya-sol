...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d5_2).
contract Kd5_2_0 {
    uint256 public log;
    ...
    function f2(uint256 a) public virtual mTwice() mGate() mGate() returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return log; }
    function f3(uint256 a) public virtual mPre() mArg(a % 5) mPost() returns (uint256) { unchecked { log = log*100 + 23 + (a % 7); } return log; }
}
contract Kd5_2_1 is Kd5_2_0 {
    function f2(uint256 a) public override mGate() mTwice() returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return log; }
    function f3(uint256 a) public override virtual mGate() returns (uint256) { unchecked { log = log*100 + 23 + (a % 7); } return super.f3(a); }
}
contract Kd5_2_2 is Kd5_2_1 {
