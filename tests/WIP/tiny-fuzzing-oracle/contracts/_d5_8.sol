...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d5_8).
contract Kd5_8_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public mBoth() mPre() mBoth() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd5_8_1 is Kd5_8_0 {
}