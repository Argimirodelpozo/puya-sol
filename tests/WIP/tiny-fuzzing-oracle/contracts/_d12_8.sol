...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d12_8).
contract Kd12_8_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mArg(a % 5) returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
...
contract Kd12_8_1 is Kd12_8_0 {
    function f1(uint256 a) public override mTwice() mBoth() mPre() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
    function f2(uint256 a) public override virtual returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return log; }
}
contract Kd12_8_2 is Kd12_8_1 {
    function f2(uint256 a) public override mTwice() mPost() returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return super.f2(a); }
