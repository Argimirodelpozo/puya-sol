...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d14_2).
contract Kd14_2_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mArg(a % 5) mBoth() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public virtual mGate() mTwice() mArg(bump(a)) returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd14_2_1 is Kd14_2_0 {
    function f1(uint256 a) public override mPre() mTwice() mGate() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
}
contract Kd14_2_2 is Kd14_2_1 {
}