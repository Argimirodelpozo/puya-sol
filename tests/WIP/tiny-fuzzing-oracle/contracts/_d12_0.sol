...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d12_0).
contract Kd12_0_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public mTwice() mArg(bump(a)) mArg(a % 5) returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd12_0_1 is Kd12_0_0 {
