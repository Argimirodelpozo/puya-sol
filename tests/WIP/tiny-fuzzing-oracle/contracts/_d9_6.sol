...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d9_6).
contract Kd9_6_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mPre() mPost() mPre() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public virtual mBoth() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd9_6_1 is Kd9_6_0 {
}
contract Kd9_6_2 is Kd9_6_1 {
}
contract Kd9_6_3 is Kd9_6_2 {
    function f0(uint256 a) public override mArg(a % 5) mPost() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
    function f1(uint256 a) public override mGate() mBoth() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; super.f1(a); }
}