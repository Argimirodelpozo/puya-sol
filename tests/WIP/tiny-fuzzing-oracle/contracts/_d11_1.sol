...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d11_1).
contract Kd11_1_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mArg(a % 5) mPre() mGate() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
    function f1(uint256 a) public mBoth() mPost() mBoth() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd11_1_1 is Kd11_1_0 {
}