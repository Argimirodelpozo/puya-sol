...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d18_5).
contract Kd18_5_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mBoth() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
...
contract Kd18_5_1 is Kd18_5_0 {
    function f1(uint256 a) public override virtual mArg(bump(a)) mArg(bump(a)) returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
    function f2(uint256 a) public override virtual returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return super.f2(a); }
}
contract Kd18_5_2 is Kd18_5_1 {
    function f1(uint256 a) public override virtual returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
    function f2(uint256 a) public override mArg(a % 5) mTwice() mTwice() returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return super.f2(a); }
}
contract Kd18_5_3 is Kd18_5_2 {
