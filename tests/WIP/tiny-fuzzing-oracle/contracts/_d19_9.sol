...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d19_9).
contract Kd19_9_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public mPost() mArg(bump(a)) returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd19_9_1 is Kd19_9_0 {
    function f0(uint256 a) public override mPre() mTwice() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
}