...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d19_1).
contract Kd19_1_0 {
    uint256 public log;
    ...
    function f2(uint256 a) public virtual mGate() mBoth() mArg(a % 5) returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return log; }
}
contract Kd19_1_1 is Kd19_1_0 {
    function f0(uint256 a) public override virtual mGate() mArg(bump(a)) { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
    function f2(uint256 a) public override mTwice() mPost() returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return super.f2(a); }
}
contract Kd19_1_2 is Kd19_1_1 {
    function f0(uint256 a) public override mPre() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
}