...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d10_5).
contract Kd10_5_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public virtual mArg(bump(a)) mPre() mTwice() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
    function f2(uint256 a) public virtual { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd10_5_1 is Kd10_5_0 {
