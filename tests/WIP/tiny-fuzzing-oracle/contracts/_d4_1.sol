...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d4_1).
contract Kd4_1_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mBoth() mGate() mPre() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
    function f1(uint256 a) public virtual mGate() mGate() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd4_1_1 is Kd4_1_0 {
    function f0(uint256 a) public override mArg(a % 5) returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
