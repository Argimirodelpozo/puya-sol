...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d15_0).
contract Kd15_0_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mBoth() mArg(bump(a)) mPre() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
    function f1(uint256 a) public virtual mArg(bump(a)) { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
    function f2(uint256 a) public virtual mTwice() returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return log; }
}
contract Kd15_0_1 is Kd15_0_0 {
    function f0(uint256 a) public override virtual returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
    function f1(uint256 a) public override virtual mPre() mArg(bump(a)) { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; super.f1(a); }
}
contract Kd15_0_2 is Kd15_0_1 {
