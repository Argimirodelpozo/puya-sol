...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d10_3).
contract Kd10_3_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mPre() mPre() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public virtual mPre() mArg(bump(a)) { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd10_3_1 is Kd10_3_0 {
    function f0(uint256 a) public override virtual mBoth() mBoth() mGate() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
}
contract Kd10_3_2 is Kd10_3_1 {
    function f0(uint256 a) public override { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
    function f1(uint256 a) public override mArg(bump(a)) mPost() mTwice() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; super.f1(a); }
}