...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d1_4).
contract Kd1_4_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mArg(a % 5) mPre() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    ...
    function f3(uint256 a) public mPost() mPost() mPost() returns (uint256) { unchecked { log = log*100 + 23 + (a % 7); } return log; }
}
contract Kd1_4_1 is Kd1_4_0 {
