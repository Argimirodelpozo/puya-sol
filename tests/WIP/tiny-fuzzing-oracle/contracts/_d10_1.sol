...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d10_1).
contract Kd10_1_0 {
    uint256 public log;
...
contract Kd10_1_1 is Kd10_1_0 {
    function f1(uint256 a) public override mArg(a % 5) mArg(a % 5) mTwice() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd10_1_2 is Kd10_1_1 {
}
contract Kd10_1_3 is Kd10_1_2 {
}