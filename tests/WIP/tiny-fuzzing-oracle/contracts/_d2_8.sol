...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d2_8).
contract Kd2_8_0 {
    uint256 public log;
...
contract Kd2_8_1 is Kd2_8_0 {
    function f0(uint256 a) public override mGate() mTwice() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
}