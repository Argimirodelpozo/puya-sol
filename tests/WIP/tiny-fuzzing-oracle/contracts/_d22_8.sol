...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d22_8).
contract Kd22_8_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public virtual mBoth() mArg(bump(a)) mPost() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
    function f2(uint256 a) public virtual mPre() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd22_8_1 is Kd22_8_0 {
    function f1(uint256 a) public override mPre() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
    function f2(uint256 a) public override virtual mTwice() mGate() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; super.f2(a); }
}
contract Kd22_8_2 is Kd22_8_1 {
