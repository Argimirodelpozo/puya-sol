...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d19_7).
contract Kd19_7_0 {
    uint256 public log;
...
contract Kd19_7_1 is Kd19_7_0 {
    function f1(uint256 a) public override mPre() mGate() mTwice() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; super.f1(a); }
}