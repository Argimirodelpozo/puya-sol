...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d14_8).
contract Kd14_8_0 {
    uint256 public log;
...
contract Kd14_8_1 is Kd14_8_0 {
    function f0(uint256 a) public override virtual mBoth() mArg(bump(a)) mTwice() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
    function f1(uint256 a) public override mArg(a % 5) returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
}
contract Kd14_8_2 is Kd14_8_1 {
    function f0(uint256 a) public override mGate() mGate() mTwice() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
}