...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d6_8).
contract Kd6_8_0 {
    uint256 public log;
...
contract Kd6_8_1 is Kd6_8_0 {
    function f0(uint256 a) public override mArg(a % 5) returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
    function f2(uint256 a) public override mArg(bump(a)) mGate() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; super.f2(a); }
}
contract Kd6_8_2 is Kd6_8_1 {
}