...
contract SqrtPriceWrap {
    function nextFromInput(uint160 p, uint128 liq, uint256 amt, bool z4o) external pure returns (uint160) { return SqrtPriceMath.getNextSqrtPriceFromInput(p, liq, amt, z4o); }
    function nextFromOutput(uint160 p, uint128 liq, uint256 amt, bool z4o) external pure returns (uint160) { return SqrtPriceMath.getNextSqrtPriceFromOutput(p, liq, amt, z4o); }
    function amount0(uint160 a, uint160 b, uint128 liq, bool up) external pure returns (uint256) { return SqrtPriceMath.getAmount0Delta(a, b, liq, up); }
    function amount1(uint160 a, uint160 b, uint128 liq, bool up) external pure returns (uint256) { return SqrtPriceMath.getAmount1Delta(a, b, liq, up); }
}
