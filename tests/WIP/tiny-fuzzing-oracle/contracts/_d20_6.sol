...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d20_6).
contract Kd20_6_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public virtual mPre() mGate() mPost() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
    function f1(uint256 a) public virtual mPost() mPost() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
    function f2(uint256 a) public mPost() mPost() mArg(bump(a)) returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return log; }
}
contract Kd20_6_1 is Kd20_6_0 {
    function f0(uint256 a) public override mArg(a % 5) returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
