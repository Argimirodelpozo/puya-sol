...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d21_7).
contract Kd21_7_0 {
    uint256 public log;
...
contract Kd21_7_1 is Kd21_7_0 {
    function f0(uint256 a) public override mGate() mGate() mTwice() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
