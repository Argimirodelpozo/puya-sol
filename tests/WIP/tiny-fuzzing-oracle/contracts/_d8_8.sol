...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d8_8).
contract Kd8_8_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mArg(bump(a)) { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
    function f2(uint256 a) public virtual mPost() returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return log; }
}
contract Kd8_8_1 is Kd8_8_0 {
    function f2(uint256 a) public override virtual mArg(a % 5) returns (uint256) { unchecked { log = log*100 + 22 + (a % 7); } return log; }
}
contract Kd8_8_2 is Kd8_8_1 {
