...
// Wrapper exposing Solady DateTimeLib pure functions for differential fuzzing.
contract DateTimeWrapper {
    function dateToEpochDay(uint256 y, uint256 m, uint256 d) external pure returns (uint256) { return DateTimeLib.dateToEpochDay(y, m, d); }
    function epochDayToDate(uint256 e) external pure returns (uint256, uint256, uint256) { return DateTimeLib.epochDayToDate(e); }
    function dateToTimestamp(uint256 y, uint256 m, uint256 d) external pure returns (uint256) { return DateTimeLib.dateToTimestamp(y, m, d); }
    function timestampToDate(uint256 t) external pure returns (uint256, uint256, uint256) { return DateTimeLib.timestampToDate(t); }
    function dateTimeToTimestamp(uint256 y, uint256 mo, uint256 d, uint256 h, uint256 mi, uint256 s) external pure returns (uint256) { return DateTimeLib.dateTimeToTimestamp(y, mo, d, h, mi, s); }
    function isLeapYear(uint256 y) external pure returns (bool) { return DateTimeLib.isLeapYear(y); }
    function daysInMonth(uint256 y, uint256 m) external pure returns (uint256) { return DateTimeLib.daysInMonth(y, m); }
    function weekday(uint256 t) external pure returns (uint256) { return DateTimeLib.weekday(t); }
    function isWeekEnd(uint256 t) external pure returns (bool) { return DateTimeLib.isWeekEnd(t); }
    function mondayTimestamp(uint256 t) external pure returns (uint256) { return DateTimeLib.mondayTimestamp(t); }
    function isSupportedTimestamp(uint256 t) external pure returns (bool) { return DateTimeLib.isSupportedTimestamp(t); }
    function isSupportedEpochDay(uint256 e) external pure returns (bool) { return DateTimeLib.isSupportedEpochDay(e); }
    function addYears(uint256 t, uint256 n) external pure returns (uint256) { return DateTimeLib.addYears(t, n); }
    function addMonths(uint256 t, uint256 n) external pure returns (uint256) { return DateTimeLib.addMonths(t, n); }
    function addDays(uint256 t, uint256 n) external pure returns (uint256) { return DateTimeLib.addDays(t, n); }
    function subYears(uint256 t, uint256 n) external pure returns (uint256) { return DateTimeLib.subYears(t, n); }
    function subMonths(uint256 t, uint256 n) external pure returns (uint256) { return DateTimeLib.subMonths(t, n); }
    function subDays(uint256 t, uint256 n) external pure returns (uint256) { return DateTimeLib.subDays(t, n); }
    function diffDays(uint256 a, uint256 b) external pure returns (uint256) { return DateTimeLib.diffDays(a, b); }
    function diffMonths(uint256 a, uint256 b) external pure returns (uint256) { return DateTimeLib.diffMonths(a, b); }
    function diffYears(uint256 a, uint256 b) external pure returns (uint256) { return DateTimeLib.diffYears(a, b); }
    function nthWeekday(uint256 y, uint256 mo, uint256 wd, uint256 n) external pure returns (uint256) { return DateTimeLib.nthWeekdayInMonthOfYearTimestamp(y, mo, wd, n); }
}
