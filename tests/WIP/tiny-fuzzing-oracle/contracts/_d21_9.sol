...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d21_9).
contract Kd21_9_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public virtual mArg(bump(a)) mBoth() mTwice() returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
}
contract Kd21_9_1 is Kd21_9_0 {
    function f1(uint256 a) public override returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return super.f1(a); }
}
contract Kd21_9_2 is Kd21_9_1 {
    function f0(uint256 a) public override mPre() mGate() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; super.f0(a); }
}
contract Kd21_9_3 is Kd21_9_2 {
}