...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d14_9).
contract Kd14_9_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public mArg(bump(a)) { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd14_9_1 is Kd14_9_0 {
