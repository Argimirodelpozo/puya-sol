...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d21_6).
contract Kd21_6_0 {
    uint256 public log;
    ...
    function f1(uint256 a) public virtual mPre() mTwice() mArg(a % 5) returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
    function f2(uint256 a) public virtual mTwice() mArg(a % 5) { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd21_6_1 is Kd21_6_0 {
    function f2(uint256 a) public override virtual mPost() mPre() { unchecked { log = log*100 + 22 + (a % 7); } sum += (a % 13) + 1; super.f2(a); }
}
contract Kd21_6_2 is Kd21_6_1 {
    function f0(uint256 a) public override returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
    function f1(uint256 a) public override mArg(a % 5) returns (uint256) { unchecked { log = log*100 + 21 + (a % 7); } return log; }
