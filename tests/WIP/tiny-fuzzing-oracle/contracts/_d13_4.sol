...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d13_4).
contract Kd13_4_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mPost() mTwice() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return log; }
    function f1(uint256 a) public virtual mPost() mArg(bump(a)) mGate() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}
contract Kd13_4_1 is Kd13_4_0 {
    function f1(uint256 a) public override mArg(bump(a)) mArg(a % 5) mBoth() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
}