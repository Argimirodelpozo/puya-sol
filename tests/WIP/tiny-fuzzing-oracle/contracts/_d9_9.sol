...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d9_9).
contract Kd9_9_0 {
    uint256 public log;
...
contract Kd9_9_1 is Kd9_9_0 {
    function f0(uint256 a) public override mPre() mGate() returns (uint256) { unchecked { log = log*100 + 20 + (a % 7); } return super.f0(a); }
