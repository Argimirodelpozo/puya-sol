...
// GENERATED modifier/inheritance/dispatch fixture (fuzz_dispatch.py, tag d21_8).
contract Kd21_8_0 {
    uint256 public log;
    ...
    function f0(uint256 a) public mArg(bump(a)) mPre() { unchecked { log = log*100 + 20 + (a % 7); } sum += (a % 13) + 1; }
    function f1(uint256 a) public virtual mBoth() mArg(bump(a)) { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
...
contract Kd21_8_1 is Kd21_8_0 {
    function f1(uint256 a) public override mPost() mBoth() { unchecked { log = log*100 + 21 + (a % 7); } sum += (a % 13) + 1; }
