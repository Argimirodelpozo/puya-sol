...
foreach(i RANGE 0 1)
	...
	foreach(j RANGE 0 ${last_method})
		...
		string(JSON member GET "${awst}" ${i} methods ${j} member_name)
		if(member STREQUAL "f")
			string(JSON source_file GET "${awst}" ${i} methods ${j} source_location file)
			if(NOT source_file STREQUAL "${input}/Base.sol")
				message(FATAL_ERROR "inherited method lost its source identity: ${source_file}")
			endif()
		endif()
