...
def test_abi_encode_with_signature_from_string(harness):
    """specialFunctions/abi_encode_with_signature_from_string.sol"""
    app = harness.compile_and_deploy("specialFunctions/abi_encode_with_signature_from_string.sol")
...
def test_abi_functions_member_access(harness):
    """specialFunctions/abi_functions_member_access.sol"""
    app = harness.compile_and_deploy("specialFunctions/abi_functions_member_access.sol")
    # f() ->
    r = harness.call(app, "f()")
    # (void return — call succeeding is the assertion)

def test_keccak256_optimized(harness):
    """specialFunctions/keccak256_optimized.sol"""
    app = harness.compile_and_deploy("specialFunctions/keccak256_optimized.sol")
    # short() -> true
