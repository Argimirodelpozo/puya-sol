...
def test_calldata_array_access(harness):
    """calldata/calldata_array_access.sol"""
    app = harness.compile_and_deploy("calldata/calldata_array_access.sol")
...
def test_calldata_array_dynamic_bytes(harness):
    """calldata/calldata_array_dynamic_bytes.sol"""
    app = harness.compile_and_deploy("calldata/calldata_array_dynamic_bytes.sol")
...
def test_calldata_array_index_range_access(harness):
    ...
    app = harness.compile_and_deploy("calldata/calldata_array_index_range_access.sol")
...
def test_calldata_array_length(harness):
    """calldata/calldata_array_length.sol"""
    app = harness.compile_and_deploy("calldata/calldata_array_length.sol")
    # f(uint256[]): 0x20, 0 -> 0
...
def test_calldata_array_three_dimensional(harness):
    """calldata/calldata_array_three_dimensional.sol"""
    app = harness.compile_and_deploy("calldata/calldata_array_three_dimensional.sol")
...
def test_calldata_attached_to_bytes(harness):
    """calldata/calldata_attached_to_bytes.sol"""
    app = harness.compile_and_deploy("calldata/calldata_attached_to_bytes.sol")
...
def test_calldata_attached_to_dynamic_array_or_slice(harness):
    """calldata/calldata_attached_to_dynamic_array_or_slice.sol"""
    app = harness.compile_and_deploy("calldata/calldata_attached_to_dynamic_array_or_slice.sol")
...
def test_calldata_attached_to_static_array(harness):
    ...
    app = harness.compile_and_deploy("calldata/calldata_attached_to_static_array.sol")
...
def test_calldata_attached_to_struct(harness):
    """calldata/calldata_attached_to_struct.sol"""
    app = harness.compile_and_deploy("calldata/calldata_attached_to_struct.sol")
...
def test_calldata_bytes_array_bounds(harness):
    """calldata/calldata_bytes_array_bounds.sol"""
    app = harness.compile_and_deploy("calldata/calldata_bytes_array_bounds.sol")
...
def test_calldata_bytes_external(harness):
    """calldata/calldata_bytes_external.sol"""
    app = harness.compile_and_deploy("calldata/calldata_bytes_external.sol")
...
def test_calldata_bytes_internal(harness):
    """calldata/calldata_bytes_internal.sol"""
    app = harness.compile_and_deploy("calldata/calldata_bytes_internal.sol")
...
def test_calldata_bytes_to_memory(harness):
    """calldata/calldata_bytes_to_memory.sol"""
    app = harness.compile_and_deploy("calldata/calldata_bytes_to_memory.sol")
...
def test_calldata_bytes_to_memory_encode(harness):
    """calldata/calldata_bytes_to_memory_encode.sol"""
    app = harness.compile_and_deploy("calldata/calldata_bytes_to_memory_encode.sol")
...
def test_calldata_internal_function_pointer(harness):
    ...
    app = harness.compile_and_deploy("calldata/calldata_internal_function_pointer.sol")
...
def test_calldata_internal_library(harness):
    """calldata/calldata_internal_library.sol"""
    app = harness.compile_and_deploy("calldata/calldata_internal_library.sol")
...
def test_calldata_internal_multi_array(harness):
    """calldata/calldata_internal_multi_array.sol"""
    app = harness.compile_and_deploy("calldata/calldata_internal_multi_array.sol")
    # g() -> 7, 8
    r = harness.call(app, "g()")
    assert tuple(r.abi_return) == (7, 8)

def test_calldata_internal_multi_fixed_array(harness):
    """calldata/calldata_internal_multi_fixed_array.sol"""
    app = harness.compile_and_deploy("calldata/calldata_internal_multi_fixed_array.sol")
    # g() -> 7, 8
    r = harness.call(app, "g()")
    assert tuple(r.abi_return) == (7, 8)

def test_calldata_memory_mixed(harness):
    """calldata/calldata_memory_mixed.sol"""
    app = harness.compile_and_deploy("calldata/calldata_memory_mixed.sol")
...
def test_calldata_string_array(harness):
    """calldata/calldata_string_array.sol"""
    app = harness.compile_and_deploy("calldata/calldata_string_array.sol")
...
def test_calldata_struct(harness):
    """calldata/calldata_struct.sol"""
    app = harness.compile_and_deploy("calldata/calldata_struct.sol")
    # test(uint256,(uint256,uint256),uint256): 7, 66, 77, 4 -> 77, 66
    r = harness.call(app, "test(uint256,(uint256,uint256),uint256)", 7, 66, 77, 4)
    assert tuple(r.abi_return) == (77, 66)

def test_calldata_struct_cleaning(harness):
    """calldata/calldata_struct_cleaning.sol"""
    app = harness.compile_and_deploy("calldata/calldata_struct_cleaning.sol")
...
def test_calldata_struct_internal(harness):
    """calldata/calldata_struct_internal.sol"""
    app = harness.compile_and_deploy("calldata/calldata_struct_internal.sol")
...
def test_copy_from_calldata_removes_bytes_data(harness):
    ...
    app = harness.compile_and_deploy("calldata/copy_from_calldata_removes_bytes_data.sol")
    # (): 1, 2, 3, 4, 5 ->
