...
// Flattened OZ v5 UUPS closure (verbatim bodies; imports/pragmas stripped)
// + a concrete UUPS implementation. Guards proxy.md Â§3 lowering.
...
contract UupsBox is UUPSUpgradeable, Ownable {
