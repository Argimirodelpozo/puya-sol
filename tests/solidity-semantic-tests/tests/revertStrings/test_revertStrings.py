...
def test_array_slices(harness):
    """revertStrings/array_slices.sol"""
    app = harness.compile_and_deploy("revertStrings/array_slices.sol")
...
def test_bubble(harness):
    """revertStrings/bubble.sol"""
    app = harness.compile_and_deploy("revertStrings/bubble.sol")
    # f() -> FAILURE, hex"08c379a0", 0x20, 4, "fail"
    r = harness.call(app, "f()", expect_revert=True)
    assert r.reverted

def test_calldata_array_dynamic_invalid(harness):
    """revertStrings/calldata_array_dynamic_invalid.sol"""
    app = harness.compile_and_deploy("revertStrings/calldata_array_dynamic_invalid.sol")
...
def test_calldata_array_dynamic_static_short_decode(harness):
    """revertStrings/calldata_array_dynamic_static_short_decode.sol"""
    app = harness.compile_and_deploy("revertStrings/calldata_array_dynamic_static_short_decode.sol")
...
def test_calldata_array_dynamic_static_short_reencode(harness):
    """revertStrings/calldata_array_dynamic_static_short_reencode.sol"""
    app = harness.compile_and_deploy("revertStrings/calldata_array_dynamic_static_short_reencode.sol")
...
def test_calldata_array_invalid_length(harness):
    """revertStrings/calldata_array_invalid_length.sol"""
    app = harness.compile_and_deploy("revertStrings/calldata_array_invalid_length.sol")
...
def test_calldata_arrays_too_large(harness):
    """revertStrings/calldata_arrays_too_large.sol"""
    app = harness.compile_and_deploy("revertStrings/calldata_arrays_too_large.sol")
...
def test_calldata_tail_short(harness):
    """revertStrings/calldata_tail_short.sol"""
    app = harness.compile_and_deploy("revertStrings/calldata_tail_short.sol")
...
def test_calldata_too_short_v1(harness):
    ...
    app = harness.compile_and_deploy("revertStrings/calldata_too_short_v1.sol")
...
def test_called_contract_has_code(harness):
    """revertStrings/called_contract_has_code.sol"""
    app = harness.compile_and_deploy("revertStrings/called_contract_has_code.sol")
...
def test_empty_v1(harness):
    ...
    app = harness.compile_and_deploy("revertStrings/empty_v1.sol")
...
def test_empty_v2(harness):
    """revertStrings/empty_v2.sol"""
    app = harness.compile_and_deploy("revertStrings/empty_v2.sol")
    # f() -> FAILURE, hex"08c379a0", 0x20, 0
    r = harness.call(app, "f()", expect_revert=True)
    assert r.reverted
...
def test_enum_v1(harness):
    ...
    app = harness.compile_and_deploy("revertStrings/enum_v1.sol")
...
def test_enum_v2(harness):
    """revertStrings/enum_v2.sol"""
    app = harness.compile_and_deploy("revertStrings/enum_v2.sol")
    # f(uint8[]): 0x20, 2, 3, 3 -> FAILURE
    r = harness.call(app, "f(uint8[])", 32, 2, 3, 3, expect_revert=True)
    assert r.reverted

def test_ether_non_payable_function(harness):
    """revertStrings/ether_non_payable_function.sol"""
    app = harness.compile_and_deploy("revertStrings/ether_non_payable_function.sol")
...
def test_function_entry_checks_v1(harness):
    ...
    app = harness.compile_and_deploy("revertStrings/function_entry_checks_v1.sol")
...
def test_function_entry_checks_v2(harness):
    """revertStrings/function_entry_checks_v2.sol"""
    app = harness.compile_and_deploy("revertStrings/function_entry_checks_v2.sol")
...
def test_invalid_abi_decoding_calldata_v1(harness):
    ...
    app = harness.compile_and_deploy("revertStrings/invalid_abi_decoding_calldata_v1.sol")
...
def test_invalid_abi_decoding_memory_v1(harness):
    ...
    app = harness.compile_and_deploy("revertStrings/invalid_abi_decoding_memory_v1.sol")
...
def test_library_non_view_call(harness):
    ...
    app = harness.compile_and_deploy("revertStrings/library_non_view_call.sol")
...
def test_short_input_array(harness):
    """revertStrings/short_input_array.sol"""
    app = harness.compile_and_deploy("revertStrings/short_input_array.sol")
    # f(uint256[]): 0x20, 1 -> FAILURE, hex"08c379a0", 0x20, 43, "ABI decoding: invalid calldata a", "rray stride"
    r = harness.call(app, "f(uint256[])", 32, 1, expect_revert=True)
    assert r.reverted

def test_short_input_bytes(harness):
    """revertStrings/short_input_bytes.sol"""
    app = harness.compile_and_deploy("revertStrings/short_input_bytes.sol")
...
def test_transfer(harness):
    ...
    app = harness.compile_and_deploy("revertStrings/transfer.sol")
    # (), 10 wei ->
...
def test_unknown_sig_no_fallback(harness):
    """revertStrings/unknown_sig_no_fallback.sol"""
    app = harness.compile_and_deploy("revertStrings/unknown_sig_no_fallback.sol")
