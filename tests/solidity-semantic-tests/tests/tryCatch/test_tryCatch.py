"""Auto-generated tests for the tryCatch category.
...
def test_panic(harness):
    ...
    assert tuple(r.abi_return) == (0, 17)
    ...
    assert tuple(r.abi_return) == (1, 0, 96, 0)
    ...
    assert tuple(r.abi_return) == (0, 17, 96, 0)
...
def test_try_catch_library_call(harness):
    ...
    assert tuple(r.abi_return) == (9, 64, 0)
