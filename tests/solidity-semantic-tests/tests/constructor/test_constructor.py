...
def test_arrays_in_constructors(harness):
    ...
    app = harness.compile_and_deploy("constructor/arrays_in_constructors.sol")
...
def test_base_constructor_arguments(harness):
    """constructor/base_constructor_arguments.sol"""
    app = harness.compile_and_deploy("constructor/base_constructor_arguments.sol")
    # getA() -> 49
...
def test_bytes_in_constructors_packer(harness):
    ...
    app = harness.compile_and_deploy("constructor/bytes_in_constructors_packer.sol")
...
def test_bytes_in_constructors_unpacker(harness):
    ...
    app = harness.compile_and_deploy("constructor/bytes_in_constructors_unpacker.sol", ctor_args=[7, 64, 78, bytes.fromhex('6162636465666768696a6b6c6d6e6f707172737475767778797a616263646566'), bytes.fromhex('6768696a6b6c6d6e6f707172737475767778797a6162636465666768696a6b6c'), bytes.fromhex('6d6e6f707172737475767778797a')])
    # m_x() -> 7
...
def test_callvalue_check(harness):
    """constructor/callvalue_check.sol"""
    app = harness.compile_and_deploy("constructor/callvalue_check.sol")
...
def test_constructor_arguments_external(harness):
    ...
    app = harness.compile_and_deploy("constructor/constructor_arguments_external.sol", ctor_args=[bytes.fromhex('616263'), True])
    # getFlag() -> true
...
def test_constructor_arguments_internal(harness):
    """constructor/constructor_arguments_internal.sol"""
    app = harness.compile_and_deploy("constructor/constructor_arguments_internal.sol")
    # getFlag() -> true
    r = harness.call(app, "getFlag()")
    assert r.abi_return is True
    # getName() -> "abc"
...
def test_constructor_function_argument(harness):
    """constructor/constructor_function_argument.sol"""
    app = harness.compile_and_deploy("constructor/constructor_function_argument.sol", ctor_args=[0xfdd67305928fcac8d213d1e47bfa6165cd0b87b946644cd0000000000000000])
    # constructor-only test — deployment succeeding is the assertion

def test_constructor_function_complex(harness):
    """constructor/constructor_function_complex.sol"""
    app = harness.compile_and_deploy("constructor/constructor_function_complex.sol")
    # f() -> 16
...
def test_constructor_static_array_argument(harness):
    ...
    app = harness.compile_and_deploy("constructor/constructor_static_array_argument.sol", ctor_args=[1, 2, 3, 4])
    # a() -> 1
...
def test_evm_exceptions_in_constructor_call_fail(harness):
    ...
    app = harness.compile_and_deploy("constructor/evm_exceptions_in_constructor_call_fail.sol")
    # testIt() ->
...
def test_function_usage_in_constructor_arguments(harness):
    """constructor/function_usage_in_constructor_arguments.sol"""
    app = harness.compile_and_deploy("constructor/function_usage_in_constructor_arguments.sol")
    # getA() -> 2
    r = harness.call(app, "getA()")
    assert r.abi_return == 2

def test_functions_called_by_constructor(harness):
    """constructor/functions_called_by_constructor.sol"""
    app = harness.compile_and_deploy("constructor/functions_called_by_constructor.sol")
    # getName() -> "abc"
    r = harness.call(app, "getName()")
    # TODO: verify expected: "abc"
    assert not r.reverted
...
def test_functions_called_by_constructor_through_dispatch(harness):
    """constructor/functions_called_by_constructor_through_dispatch.sol"""
    app = harness.compile_and_deploy("constructor/functions_called_by_constructor_through_dispatch.sol")
...
def test_inline_member_init_inheritence_without_constructor(harness):
    """constructor/inline_member_init_inheritence_without_constructor.sol"""
    app = harness.compile_and_deploy("constructor/inline_member_init_inheritence_without_constructor.sol")
    # getBMember() -> 5
...
def test_no_callvalue_check(harness):
    ...
    app = harness.compile_and_deploy("constructor/no_callvalue_check.sol")
    # f(), 2000 ether -> true
    r = harness.call(app, "f()", payment_wei=2000000000000000000000)
    assert r.abi_return is True

def test_order_of_evaluation(harness):
    """constructor/order_of_evaluation.sol"""
    app = harness.compile_and_deploy("constructor/order_of_evaluation.sol")
    # g() -> 0x20, 4, 1, 3, 2, 4
...
def test_payable_constructor(harness):
    """constructor/payable_constructor.sol"""
    app = harness.compile_and_deploy("constructor/payable_constructor.sol", fund_wei=27)
    # constructor-only test — deployment succeeding is the assertion

def test_state_variable_initialization(harness):
    """constructor/state_variable_initialization.sol"""
    app = harness.compile_and_deploy("constructor/state_variable_initialization.sol")
    # i() -> 2
...
def test_store_function_in_constructor(harness):
    ...
    app = harness.compile_and_deploy("constructor/store_function_in_constructor.sol")
    # use(uint256): 3 -> 6
...
def test_store_function_in_constructor_packed(harness):
    ...
    app = harness.compile_and_deploy("constructor/store_function_in_constructor_packed.sol")
    # use(uint16): 3 -> 0xfff9
...
def test_store_internal_unused_function_in_constructor(harness):
    ...
    app = harness.compile_and_deploy("constructor/store_internal_unused_function_in_constructor.sol")
    # t() -> 7
...
def test_store_internal_unused_library_function_in_constructor(harness):
    ...
    app = harness.compile_and_deploy("constructor/store_internal_unused_library_function_in_constructor.sol")
    # t() -> 7
    r = harness.call(app, "t()")
    assert r.abi_return == 7

def test_transient_state_variable_initialization(harness):
    """constructor/transient_state_variable_initialization.sol"""
    app = harness.compile_and_deploy("constructor/transient_state_variable_initialization.sol")
    # f() -> 100
    r = harness.call(app, "f()")
