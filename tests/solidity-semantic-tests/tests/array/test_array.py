...
def test_array_storage_length_access(harness):
    ...
    app = harness.compile_and_deploy("array/contracts/array_storage_length_access.sol")
...
def test_array_storage_push_empty_length_address(harness):
    ...
    app = harness.compile_and_deploy("array/contracts/array_storage_push_empty_length_address.sol")
    # set_get_length(uint256): 0 -> 0
    r = harness.call(app, "set_get_length(uint256)", 0)
    assert r.abi_return == 0
    # set_get_length(uint256): 1 -> 1
...
def test_array_storage_push_pop(harness):
    ...
    app = harness.compile_and_deploy("array/contracts/array_storage_push_pop.sol")
    # set_get_length(uint256): 0 -> 0
    r = harness.call(app, "set_get_length(uint256)", 0)
    assert r.abi_return == 0
