...
import type {
  ...
  IIdentityVerificationHubV2Interface,
} from "../../../contracts/interfaces/IIdentityVerificationHubV2";
...
export class IIdentityVerificationHubV2__factory {
  static readonly abi = _abi;
  static createInterface(): IIdentityVerificationHubV2Interface {
    return new Interface(_abi) as IIdentityVerificationHubV2Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IIdentityVerificationHubV2;
  }
}
