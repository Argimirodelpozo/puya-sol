...
// Flattened: Context + Ownable + Ownable2Step
// Source: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.0.0/contracts/
// Modification: `delete _pendingOwner` → `_pendingOwner = address(0)` (delete statement not yet supported)
...
contract Ownable2StepTest is Ownable2Step {
