/// @file FunctionInlinerTransforms.cpp
///
/// AWST traversals split out of FunctionInliner.cpp: variable renaming,
/// block/expression flattening, and deep-copying. Each group walks the AWST
/// node hierarchy by hand. The orchestration methods (inlineAll,
/// buildCallableMaps, inlineBlock, inlineCall) remain in FunctionInliner.cpp.
