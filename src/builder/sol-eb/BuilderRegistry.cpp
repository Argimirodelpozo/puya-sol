...
BuilderRegistry::BuilderRegistry()
{
	...
	registerInstance(Cat::Integer, [](ContractContext& ctx, solidity::frontend::Type const* solType, std::shared_ptr<awst::Expression> expr) -> std::unique_ptr<InstanceBuilder> {
	...
	registerInstance(Cat::Bool, [](ContractContext& ctx, solidity::frontend::Type const* solType, std::shared_ptr<awst::Expression> expr) -> std::unique_ptr<InstanceBuilder> {
		return std::make_unique<SolBoolBuilder>(ctx, std::move(expr));
	});

	registerInstance(Cat::Address, [](ContractContext& ctx, solidity::frontend::Type const* solType, std::shared_ptr<awst::Expression> expr) -> std::unique_ptr<InstanceBuilder> {
		return std::make_unique<SolAddressBuilder>(ctx, solType, std::move(expr));
	});

	registerInstance(Cat::Enum, [](ContractContext& ctx, solidity::frontend::Type const* solType, std::shared_ptr<awst::Expression> expr) -> std::unique_ptr<InstanceBuilder> {
	...
	registerInstance(Cat::FixedBytes, [](ContractContext& ctx, solidity::frontend::Type const* solType, std::shared_ptr<awst::Expression> expr) -> std::unique_ptr<InstanceBuilder> {
	...
	registerInstance(Cat::Array, [](ContractContext& ctx, solidity::frontend::Type const* solType, std::shared_ptr<awst::Expression> expr) -> std::unique_ptr<InstanceBuilder> {
