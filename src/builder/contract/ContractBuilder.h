...
private:
	...
	/// Pending modifier links and ABI-wrapper targets emitted with a method.
	...
	/// Shared runtime self-call routing over a byte payload, using solc's interface.
	void emitSelfCallDispatch(
		solidity::frontend::ContractDefinition const& _contract, awst::Contract& _awstContract);
